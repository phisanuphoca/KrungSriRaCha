            ...
            <br>
                          ...
                          <div class="tb_pro">
                            <table class="pro while " border="1" style="width: 100%;">
                              ...
                              <button type="submit" onclick="parent.location.href='{{ route('box.show',$User->UserID) }}'" style="margin-left: 15px;"  class="submit shadow" ><span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span> &nbsp;คลังของฉัน</button>&nbsp;
...
">
    ...
    margin-right: auto!important;">
            ...
            <br>
                          ...
                          <div class="img222">
                          <img id="aaa" src="{{ asset('img/profile.png') }}"/>
                          </div>
                          <div class="tb_pro">
                            <table class="pro while " border="1" style="width: 100%;">
                                <tbody>
