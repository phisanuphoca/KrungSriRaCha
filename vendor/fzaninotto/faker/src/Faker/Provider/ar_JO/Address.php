            ...
            <div class="navbar2">
              ...
              <div class="menu">
                    <ul id="nav">
                        ...
                        <li><a href="<?php echo e(route('login')); ?>">เข้าสู่ระบบ</a>
                    </li>
                </ul>
              </div>
          </div>
...
">สมัครสมาชิก</p>
  ...
  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
						...
						<p class="text-center" style="margin-bottom: 10px; color:#EEE">ไอดีผู้ใช้ (Username)&nbsp; <aa style="color:#FF0000"><?php echo e($textUser); ?></aa></p>
